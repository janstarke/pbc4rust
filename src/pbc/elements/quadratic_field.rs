...
impl<E, F> HasZero<Quadratic<E, F>> for QuadraticField<E, F> where E: Element<AtomicElement>, F:FiniteField<E, AtomicElement> {
...
impl<E, F> HasOne<Quadratic<E, F>> for QuadraticField<E, F> where E: Element<AtomicElement>, F:FiniteField<E, AtomicElement> {
...
impl<E, F> Field<Quadratic<E, F>, ComplexElement> for QuadraticField<E, F> where E: Element<AtomicElement>, F:FiniteField<E, AtomicElement> {
